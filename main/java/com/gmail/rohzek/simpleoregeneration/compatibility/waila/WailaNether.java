package com.gmail.rohzek.simpleoregeneration.compatibility.waila;
...
public class WailaNether implements IWailaDataProvider
{	
	@Override
	...
	{
		WailaNether instance = new WailaNether();
