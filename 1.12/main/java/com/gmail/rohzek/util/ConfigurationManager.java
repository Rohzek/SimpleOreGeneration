...
public class ConfigurationManager
{
	...
	public static boolean gfFlowerOPRecipe;
	...
	private void options(Configuration config)
	{
		...
		this.gfFlowerOPRecipe = config.get(genCategory, "gfFlowerOPRecipe", true, "True will enable getting heart diamonds from the Cheshire Rose flower..").getBoolean(true);
