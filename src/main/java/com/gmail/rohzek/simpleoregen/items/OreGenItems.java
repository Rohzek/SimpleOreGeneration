...
{
	// Raws
	public static final DeferredItem<Item> RAW_ALUMINIUM = DeferredRegistration.ITEMS.register("raw_aluminum", () -> new OreGenRawOre("raw_aluminum"));
	...
	// Ingots
	public static final DeferredItem<Item> ALUMINIUM_INGOT = DeferredRegistration.ITEMS.register("aluminum_ingot", () -> new OreGenIngot("aluminum_ingot"));
	...
	// Nuggets
	public static final DeferredItem<Item> ALUMINIUM_NUGGET = DeferredRegistration.ITEMS.register("aluminum_nugget", () -> new OreGenIngot("aluminum_nugget"));
