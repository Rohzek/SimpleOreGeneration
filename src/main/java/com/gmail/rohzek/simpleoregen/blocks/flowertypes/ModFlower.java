package com.gmail.rohzek.simpleoregen.blocks.flowertypes;
...
public class ModFlower extends FlowerBlock
{
	public ModFlower(String name) 
	 ...
	 public ModFlower(SuspiciousStewEffects suspiciousStewEffects, BlockBehaviour.Properties properties) 
	 {
