...
public class OreGenBlocks 
{
	...
	public static final DeferredBlock<Block> SURFACE_CHAOS_ORE = DeferredRegistration.registerBlock("chaos_ore", () -> new ChaosOreBlock("chaos_ore", 3f, 3f));
	...
	public static final DeferredBlock<Block> SURFACE_DEEPSLATE_CHAOS_ORE = DeferredRegistration.registerBlock("deepslate_chaos_ore", () -> new ChaosOreBlock("deepslate_chaos_ore", 3f, 3f));
	...
	public static final DeferredBlock<Block> ANDESITE_CHAOS_ORE = DeferredRegistration.registerBlock("andesite_chaos_ore", () -> new ChaosOreBlock("andesite_chaos_ore", 3f, 3f));
	...
	public static final DeferredBlock<Block> DIORITE_CHAOS_ORE = DeferredRegistration.registerBlock("diorite_chaos_ore", () -> new ChaosOreBlock("diorite_chaos_ore", 3f, 3f));
	...
	public static final DeferredBlock<Block> GRANITE_CHAOS_ORE = DeferredRegistration.registerBlock("granite_chaos_ore", () -> new ChaosOreBlock("granite_chaos_ore", 3f, 3f));
	...
	public static final DeferredBlock<Block> SANDSTONE_CHAOS_ORE = DeferredRegistration.registerBlock("sandstone_chaos_ore", () -> new ChaosOreBlock("sandstone_chaos_ore", 3f, 3f));
	...
	public static final DeferredBlock<Block> SAND_ZINC_ORE = DeferredRegistration.registerBlock("sand_zinc_ore", () -> new GravityOreBlock("sand_zinc_ore", new ColorRGBA(14406560),
            BlockBehaviour.Properties.of().mapColor(MapColor.SAND).instrument(NoteBlockInstrument.SNARE).strength(0.5F).sound(SoundType.SAND)));
	public static final DeferredBlock<Block> SAND_CHAOS_ORE = DeferredRegistration.registerBlock("sand_chaos_ore", () -> new GravityChaosOreBlock("sand_chaos_ore", new ColorRGBA(14406560),
            BlockBehaviour.Properties.of().mapColor(MapColor.SAND).instrument(NoteBlockInstrument.SNARE).strength(0.5F).sound(SoundType.SAND).noLootTable()));
	...
	public static final DeferredBlock<Block> GRAVEL_ZINC_ORE = DeferredRegistration.registerBlock("gravel_zinc_ore", () -> new GravityOreBlock("gravel_zinc_ore", new ColorRGBA(-8356741),
            BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.SNARE).strength(0.6F).sound(SoundType.GRAVEL)));
	public static final DeferredBlock<Block> GRAVEL_CHAOS_ORE = DeferredRegistration.registerBlock("gravel_chaos_ore", () -> new GravityChaosOreBlock("gravel_chaos_ore", new ColorRGBA(-8356741),
            BlockBehaviour.Properties.of().mapColor(MapColor.STONE).instrument(NoteBlockInstrument.SNARE).strength(0.6F).sound(SoundType.GRAVEL).noLootTable()));
	...
	public static final DeferredBlock<Block> NETHER_CHAOS_ORE = DeferredRegistration.registerBlock("nether_chaos_ore", () -> new NetherChaosOreBlock("nether_chaos_ore", 3f, 3f));
	
	// End - Vanilla
	public static final DeferredBlock<Block> END_COAL_ORE = DeferredRegistration.registerBlock("end_coal_ore", () -> new EndOreBlock("end_coal_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_COPPER_ORE = DeferredRegistration.registerBlock("end_copper_ore", () -> new EndOreBlock("end_copper_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_DIAMOND_ORE = DeferredRegistration.registerBlock("end_diamond_ore", () -> new EndOreBlock("end_diamond_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_EMERALD_ORE = DeferredRegistration.registerBlock("end_emerald_ore", () -> new EndOreBlock("end_emerald_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_GOLD_ORE = DeferredRegistration.registerBlock("end_gold_ore", () -> new EndOreBlock("end_gold_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_IRON_ORE = DeferredRegistration.registerBlock("end_iron_ore", () -> new EndOreBlock("end_iron_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_REDSTONE_ORE = DeferredRegistration.registerBlock("end_redstone_ore", () -> new EndOreBlock("end_redstone_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_LAPIS_ORE = DeferredRegistration.registerBlock("end_lapis_ore", () -> new EndOreBlock("end_lapis_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_QUARTZ_ORE = DeferredRegistration.registerBlock("end_quartz_ore", () -> new EndOreBlock("end_quartz_ore", 3f, 3f));
	
	// Modded
	public static final DeferredBlock<Block> END_BAUXITE_ORE = DeferredRegistration.registerBlock("end_bauxite_ore", () -> new EndOreBlock("end_bauxite_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_COBALT_ORE = DeferredRegistration.registerBlock("end_cobalt_ore", () -> new EndOreBlock("end_cobalt_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_IRIDIUM_ORE = DeferredRegistration.registerBlock("end_iridium_ore", () -> new EndOreBlock("end_iridium_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_LEAD_ORE = DeferredRegistration.registerBlock("end_lead_ore", () -> new EndOreBlock("end_lead_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_NICKEL_ORE = DeferredRegistration.registerBlock("end_nickel_ore", () -> new EndOreBlock("end_nickel_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_PLATINUM_ORE = DeferredRegistration.registerBlock("end_platinum_ore", () -> new EndOreBlock("end_platinum_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_RUBY_ORE = DeferredRegistration.registerBlock("end_ruby_ore", () -> new EndOreBlock("end_ruby_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_SAPPHIRE_ORE = DeferredRegistration.registerBlock("end_sapphire_ore", () -> new EndOreBlock("end_sapphire_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_SILVER_ORE = DeferredRegistration.registerBlock("end_silver_ore", () -> new EndOreBlock("end_silver_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_TIN_ORE = DeferredRegistration.registerBlock("end_tin_ore", () -> new EndOreBlock("end_tin_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_TUNGSTEN_ORE = DeferredRegistration.registerBlock("end_tungsten_ore", () -> new EndOreBlock("end_tungsten_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_URANIUM_ORE = DeferredRegistration.registerBlock("end_uranium_ore", () -> new EndOreBlock("end_uranium_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_ZINC_ORE = DeferredRegistration.registerBlock("end_zinc_ore", () -> new EndOreBlock("end_zinc_ore", 3f, 3f));
	public static final DeferredBlock<Block> END_CHAOS_ORE = DeferredRegistration.registerBlock("end_chaos_ore", () -> new EndChaosOreBlock("end_chaos_ore", 3f, 3f));
